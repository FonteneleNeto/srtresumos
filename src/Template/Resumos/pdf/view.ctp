...
<div class="row">
    ...
    <div class="col-lg-2">
        <div class="pull-right">
            <a class="btn btn-block btn-primary hidden-print" href="https://www.runservices.com.br/srtresumos/users/index"><i class="fa fa-hand-o-left"></i> Voltar</a>
            <button class="btn btn-block btn-success hidden-print" onClick="window.location.reload();"><i class="fa  fa-refresh"></i> Atualizar</button>
        </div>
    </div>
</div>
<br>
